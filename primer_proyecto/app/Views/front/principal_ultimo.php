<div class="content py-3 my-3">
    ...
    <div class="container-fluid inicio">
        <div class="row">
                <p class="lh-5 fw-normal">Abre las puertas al fascinante mundo de la programación: donde cada línea de código es un paso hacia la creación de un futuro digital lleno de posibilidades infinitas.</p>
                <!--Inicio del carrusel-->
